...
[![GitHub all releases](https://img.shields.io/github/downloads/Griefed/monitoring/total?color=c0ffee&logo=GitHub&logoColor=white&labelColor=325358&style=for-the-badge)](https://github.com/Griefed/monitoring/releases)
...
|------------------------------|----------------------------|
| ![light home](img/light.png) | ![dark home](img/dark.png) |
...
All you need is a `hosts.json` file in the base directory in which you are executing Monitoring, and you're good to go.
Here's an example for a `hosts.json`-file:
...
Download the latest jar-file from the releases-page and execute it with `java -jar Monitoring-$VERSION.jar`. This will generate all default files and most importantly, the `application.properties` file.
